package org.chief.day12.collection.set;
...
public class Exam_SetCollection {
	...
	public static void main(String[] args) {
		...
		stdSet.add(new Student("이세운", 90, 80));
		stdSet.add(new Student("허태성", 88, 44));
		stdSet.add(new Student("남궁성", 78, 67));
		stdSet.add(new Student("이세운", 90, 80));
		
		System.out.println("크기 : " + stdSet.size());	//당연히 3이 나와야지!!! 하지만 위에서 새로운 인스턴스 주소를 4번 넘겼기 때문에 4개가 들어갔다.
	...
	public void setSample() {
		...
		//수학의 집합 : 순서가 중요하지 않음(순서를 보장하지 않는다), 중복을 허용하지 않음
